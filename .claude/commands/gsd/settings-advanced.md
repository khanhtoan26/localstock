...
<execution_context>
@/home/toanak/workspace/localstock/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@/home/toanak/workspace/localstock/.claude/get-shit-done/workflows/settings-advanced.md`.
