...
Intel system is disabled. To activate:
  ...
  node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
