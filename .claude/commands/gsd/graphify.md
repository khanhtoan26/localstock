...
Knowledge graph is disabled. To activate:
  ...
  node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
