...
- Usage: Reference from command with `@/home/toanak/workspace/localstock/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/toanak/workspace/localstock/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/toanak/workspace/localstock/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
