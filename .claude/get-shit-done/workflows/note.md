...
- **Global scope**: `/home/toanak/playground/localstock/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/toanak/playground/localstock/.claude/notes/`)
...
2. Glob `/home/toanak/playground/localstock/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/toanak/playground/localstock/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/toanak/playground/localstock/.claude/notes/` — works in any directory
