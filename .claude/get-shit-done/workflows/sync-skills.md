...
INSTALL_JS_GLOBAL="/home/toanak/workspace/localstock/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/toanak/workspace/localstock/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
