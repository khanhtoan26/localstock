...
Reference full template: `/home/toanak/workspace/localstock/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/toanak/workspace/localstock/.claude/get-shit-done/templates/state.md`.
