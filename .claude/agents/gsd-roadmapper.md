...
Reference full template: `/home/toanak/playground/localstock/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/toanak/playground/localstock/.claude/get-shit-done/templates/state.md`.
