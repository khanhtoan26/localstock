...
<required_reading>
@/home/toanak/playground/localstock/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/toanak/playground/localstock/.claude
                  → checks /home/toanak/playground/localstock/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/toanak/playground/localstock/.claude/get-shit-done
                  → writes to /home/toanak/playground/localstock/.claude/get-shit-done/hooks/
...
@/home/toanak/playground/localstock/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/toanak/playground/localstock/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
