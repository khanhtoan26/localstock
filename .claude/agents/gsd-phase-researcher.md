...
```bash
node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/home/toanak/playground/localstock/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
...
```bash
node "/home/toanak/playground/localstock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
