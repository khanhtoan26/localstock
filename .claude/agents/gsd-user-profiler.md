...
<reference>
@/home/toanak/playground/localstock/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/toanak/playground/localstock/.claude/get-shit-done/references/user-profiling.md` to load:
