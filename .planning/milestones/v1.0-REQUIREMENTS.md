...
- [x] **MACR-01**: Agent thu thập dữ liệu vĩ mô: lãi suất (SBV), tỷ giá USD/VND, CPI, GDP
- [x] **MACR-02**: Agent phân tích tác động vĩ mô đến từng ngành/mã cổ phiếu (VD: lãi suất tăng → tiêu cực cho bất động sản, tích cực cho ngân hàng)
...
- [x] **T3-01**: Khi gợi ý mã lướt sóng, agent dự đoán xu hướng ít nhất 3 ngày tới (do quy tắc T+3 của HOSE — mua hôm nay, 3 ngày sau mới bán được)
- [x] **T3-02**: Agent phân biệt rõ ràng giữa gợi ý đầu tư dài hạn và gợi ý lướt sóng, kèm cảnh báo T+3

### AI Reports

- [x] **REPT-01**: LLM local (Ollama) tổng hợp phân tích đa chiều thành báo cáo tiếng Việt cho từng mã, giải thích TẠI SAO điểm cao/thấp
- [x] **REPT-02**: Báo cáo bao gồm: tín hiệu kỹ thuật, đánh giá cơ bản, sentiment tin tức, ảnh hưởng vĩ mô, và khuyến nghị tổng hợp
...
- [x] **DASH-01**: Web dashboard hiển thị bảng xếp hạng cổ phiếu theo điểm tổng hợp
- [x] **DASH-02**: Dashboard cho phép xem chi tiết từng mã: biểu đồ giá, chỉ báo kỹ thuật, báo cáo AI
- [x] **DASH-03**: Dashboard hiển thị tổng quan thị trường và phân tích vĩ mô
